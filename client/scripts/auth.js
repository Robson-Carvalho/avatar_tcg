...
function toggleAuth() {
    isLogin = !isLogin;
    document.getElementById("authTitle").innerText = isLogin ? "Login" : "Cadastro";
    document.getElementById("authBtn").innerText = isLogin ? "Entrar" : "Cadastrar";

    document.getElementById("toggleText").innerText = isLogin ? "Não tem conta?" : "Já tem uma conta?";
    document.getElementById("toggleBtn").innerText = isLogin ? "Cadastre-se" : "Login";
    ...
    document.getElementById("confirmPassword").classList.toggle("hidden", isLogin);
