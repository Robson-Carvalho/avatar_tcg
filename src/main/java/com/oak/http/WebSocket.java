...
public class WebSocket {
    ...
    public WebSocket(Socket socket, OakRequest request) throws IOException {
        this.socket = socket;
    ...
    public static void doHandshake(OakRequest request, OakResponse response) throws IOException {
